...
def create_widgets():
    ...
    label_layout = {'layout': widgets.Layout(width='60%')}
    ...
    widget_layout = widgets.VBox([b_widget_line, a_widget_line])
    widget_layout = widgets.HBox([title_widget, widget_layout])
